...
<html>
    ...
    <body>
        ...
        %>
    <header>
        <br><pre><a><img src="IMG/logo2.jpg" align="left" width="50" height="50"></a>                     <a class="titulo">Registrar Consultorio</a>                                                                                                              <a  href="IndAdmin.jsp"><button class="volver"align="right">Volver</button></a></pre></header> 
    </header>
                ...
                <tbody>
                    ...
                    <tr align="center">
                        <td colspan="2" rowspan="1">
                            <input value="Agregar Consultorio" name="accion"   type="submit" onclick="algoritmo();"/>
                        </td>
                    </tr>
                </tbody>
            </table>
